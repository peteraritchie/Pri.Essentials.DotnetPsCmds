...
public partial class CreateClassLibProjectCommandWhenNoClass1Should
	: CommandTestingBase<CreateClassLibProjectCommand>
{
	public CreateClassLibProjectCommandWhenNoClass1Should()
		...
		IFileSystem mockFileSystem)
	{
		return new CreateClassLibProjectCommand(shellExecutor: shellExecutor,
			...
			outputName: "Library",
			frameworkName: SupportedFrameworkName.Net9, mockFileSystem);
	}
